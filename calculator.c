...
//	引数	：	double num1	-	ユーザーからの入力で取得する1つ目の数値
//			：	double num2	-	ユーザーからの入力で取得する2つ目の数値
//			：	char symbol	-	ユーザーからの入力で取得する演算子
//	戻り値	：	0	-	正常終了
//			：	-1	-	入力が不正
//-------------------------------------------------------------------------------
static int get_CalcNum(double* num1, double* num2, char* symbol)
...
//	関数名	：	printCalc
//	概要	：	計算結果を画面に出力
//	引数	：	double num1	-	ユーザーからの入力で取得した1つ目の数値
//			：	double num2	-	ユーザーからの入力で取得した2つ目の数値
//			：	char symbol	-	ユーザーからの入力で取得した演算子
//	戻り値	：	0	-	正常終了
//			：	-1	-	異常終了
//-------------------------------------------------------------------------------
static int printCalc(double num1, double num2, char symbol)
